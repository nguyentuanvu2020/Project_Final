    ...
    <div class="col-xs-12 pd5">
        <div class="group-collection">
            <div class="title-block">
                <h1 class="title-group">Giày Nike</h1>
                <div class="browse-tags pull-right hidden-xs">
                    ...
                    <span class="custom-dropdown custom-dropdown--white">
                        <select class="sort-by custom-dropdown__select custom-dropdown__select--white"  onchange="location = this.value;">
                            ...
                            <option value="hot-sell-prduct">Sản phẩm bán chạy nhất</option>
                            <option value="top-favorite-prduct">Sản phẩm được nhiều người yêu thích</option>
                        </select>
                    </span>
                </div>
            </div>
