                                    ...
                                    <div class="step-sections " step="1">
                                        <div class="section">
                                            <div class="section-content section-customer-indivation no-mb">
                                                <p class="alert alert-danger" id="messageEmail1" style="display: none"></p>
                                                <div class="fieldset">
                                                    <div class="field ">
                                                    ...
                                                    <div id="div_next_step" accept-charset="UTF-8">
                                                        <button type="submit" class="step-footer-continue-btn btn" id="submit_getpw">
                                                            <span class="btn-content">Lấy lại mật khẩu</span>
            ...
            function checkEmail() {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState === 4 && this.status === 200 && this.responseText === "fasle") {
                        ...
                        document.getElementById("submit_getpw").disabled = true;
                    } else {
                        document.getElementById("messageEmail1").style.display = "none";
                        document.getElementById("submit_getpw").disabled = false;
                    }
                };
            }
        </script>
