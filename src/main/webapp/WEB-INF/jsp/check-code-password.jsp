                                    ...
                                    <div class="step-sections " step="1">
                                        <div class="section">
                                            <div class="section-content section-customer-indivation no-mb">
                                                <p class="alert alert-danger" id="messageEmail1" style="display: block">${code}</p>
                                                <div class="fieldset">
                                                    <div class="field ">
                                                        <div class="field-input-wrapper">
                                                            <label class="field-label" for="check_email">Nhập Code</label>
                                                            <input required="" placeholder="Nhập mã code" autocapitalize="off" spellcheck="false" class="field-input" size="30" type="number" id="check_email" name="code" value="" />
                                                        </div>
                                                    </div>
