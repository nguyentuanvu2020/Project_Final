                                ...
                                <div class="filter-box">
                                    <ul id="menusidebarleft" class="menu-collection clearfix mb15">
                                        <li class=" submenu-parent" aria-expanded="false">
                                            <a href="javascript:void(0);" title="Giày Chính Hãng">Thông tin cá nhân</a>
                                            ...
                                            <ul class="dropdown-menu default-none-dropdown-menu pd-l-10">
                                                <li class="">
                                                    <a href="/collections/giay-nike" title="Giày Nike">Hồ sơ</a>
                                                </li>
                                                <li class="">
                                                    <a href="/collections/giay-jordan" title="Giày Jordan">Quản lý địa chỉ</a>
                                                </li>
                                                <li class="">
                                                    <a href="/collections/giay-timberland" title="Giày Timberland">Thay đổi mật khẩu</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="">
                                    ...
                                    <div class="list-product-related">
                                        <form class="form-horizontal" action="/action_page.php">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="name" value="Nguyễn Tuấn Vũ">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="email">Email</label>
                                                <div class="col-sm-10">
                                                    <input type="email" disabled class="form-control" id="email" value="zxczxczc@gmail.com">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="phoneNumber">Số điện thoại</label>
                                                <div class="col-sm-10">
                                                    <input type="number" disabled class="form-control" id="phoneNumber" value="0123123123">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="phoneNumber">Sinh nhật</label>
                                                <div class="col-sm-10">
                                                    <input type="date"  class="form-control" id="phoneNumber" value="0123123123">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="phoneNumber">Giới tính</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="phoneNumber">Địa chỉ</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" rows="5" id="comment">Huế City</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
