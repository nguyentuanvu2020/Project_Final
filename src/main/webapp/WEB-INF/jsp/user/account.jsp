                            ...
                            <div id="product-related" class="mb10">
                                <div class="wrapper-product-related">
                                    ...
                                    <div class="list-product-related">
                                        <mvc:form modelAttribute="account" id="form" action="${action}" class="form-horizontal" method="post">
                                            <br>
                                            <input type="hidden" value="${account.id}" name="id">
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="name">Họ Tên</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="name" value="${account.name}" name="name">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="email">Email</label>
                                                <div class="col-sm-10">
                                                    <input type="email" disabled class="form-control" id="email" value="${account.email}" name="email">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="phoneNumber">Số điện thoại</label>
                                                <div class="col-sm-10">
                                                    <input type="number" disabled class="form-control" id="phoneNumber" value="${account.phoneNumber}" name="phoneNumber">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="birthDate">Sinh nhật</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="comment">Địa chỉ</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" rows="5" id="comment" name="address">${account.address}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
