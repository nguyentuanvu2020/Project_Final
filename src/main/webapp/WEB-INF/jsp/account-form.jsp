                        ...
                        <div class="col-sm-6">
                            <div class="well">
                                <div class="main-content">
                                    <mvc:form modelAttribute="customer" id="form" action="${pageContext.request.contextPath}/${action}" class="step" method="post">
                                            ...
                                            <div class="section">
                                                <div class="section-content section-customer-indivation no-mb">
                                                    ...
                                                    <div class="fieldset">
                                                        <div class="field   ">
                                                            <div class="field-input-wrapper">
                                                                <label class="field-label" for="billing_address_full_name">Mật Khẩu</label>
                                                                <input required="" placeholder="Mật Khẩu" autocapitalize="off" spellcheck="false" class="field-input" size="30" type="password" id="password" name="password" value="" />
                                                            </div>
                                                        </div>
                                                        <p id="message"></p>
                                                        <div class="field   ">
                                                            <div class="field-input-wrapper">
                                                                <label class="field-label" for="billing_address_full_name">Nhập Lại Mật Khẩu</label>
                                                                <input required="" placeholder="Nhập lại Mật Khẩu" autocapitalize="off" spellcheck="false" class="field-input" size="30" type="password" id="confirm_password" name="confirm_password" value="" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="field">
                                                            <div class="field-input-wrapper">
                                                                <label class="field-label" for="billing_address_address1">Ngày sinh</label>
                                                                <input required="" placeholder="Ngày sinh" autocapitalize="off" spellcheck="false" class="field-input" size="30" type="date" id="billing_address_address1" name="birthDate" value="" />
                                                            </div>
                                                        </div>
                                                        <div class="field field-show-floating-label">
                                                            <div class="field-input-wrapper field-input-wrapper-select">
                                                                <label class="field-label" for="customer_shipping_province"> Giới tính </label>
                                                                <select required="" class="field-input" id="customer_shipping_province" name="gender">

                                                                    <option data-code="null" value="null">  Chọn giới tính</option>
                                                        ...
                                                        <div id="div_next_step" accept-charset="UTF-8">
                                                            <button type="submit" class="step-footer-continue-btn btn" id="submit_register">
