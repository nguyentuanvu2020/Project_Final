...
var Nobita = {
    ...
    clone_item: function (product) {
        ...
        item_product.find('.pro-quantity-view').html('Sá»‘ lÆ°á»£ng: ' + product.quantity);
        item_product.find('.pro-price-view').html('GiĂ¡: ' + Haravan.formatMoney(product.price, formatMoney));
